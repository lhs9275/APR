...
# ===== 경로 설정 =====
DEFAULT_IN_PATH = Path("./Results/4.GeneratePromResult__wo_retrieval.json")
DEFAULT_OUT_PATH = Path("Results/patch/5.GeneratePromResult__wo_retrieval.json")
...
def get_parser():
    ...
    parser.add_argument("--model_name", type=str, default="../DevAgent/qwen1.5-7b-chat", help="사용할 모델의 경로 또는 이름")
