...
def main():
    ...
    parser.add_argument("--input_json", default="./Results/1.DataSeterAgentResult_Java.json", help="분석할 버그 데이터가 담긴 JSON 파일")
    parser.add_argument("--output_json", default="./Results/2.LLM_Analyzed_Results_Java.json", help="분석 결과를 저장할 JSON 파일 경로")
    ...
    parser.add_argument("--ast_metrics_out", default="./Results/2.ast_parse_metrics_Java.json", help="AST 파싱 메트릭 저장 경로(JSON)")
