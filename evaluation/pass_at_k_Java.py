...
def main():
    ...
    for model_inference_dir in args.model_inference_dirs.split(','):
        ...
        file_pattern = f"{_evaluate_path}/unittest_result_5.PatchesResults_Java.json"
        ...
        result_ = _evaluate_average_pass_at_k(combined_eval_results, k_list, total_bug_count=118)
        ...
        pass_k_result_path = f"{_evaluate_path}/unittest_result_5.PatchesResults_Java.txt"
