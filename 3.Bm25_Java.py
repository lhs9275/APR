...
def main():
    ...
    parser.add_argument("--all_bugs", default="./defects4j_bugs_meta_data.json",
                        help="코퍼스(all bugs) JSON 경로 (dict 또는 list 허용)")
    parser.add_argument("--real_bugs", default="./Results/2.LLM_Analyzed_Results_Java.json",
                        help="실제 버그(by func) JSON 경로 (dict[func_id]->object)")
    parser.add_argument("--out", default="./Results/3.BM25Result_Java.json",
                        help="출력 파일(JSON)")
